...
let EditionService = class EditionService {
    constructor(editionRepository) {
        this.editionRepository = editionRepository;
    }
    async create(createEditionDto) {
    ...
    async update(id, updateEditionDto) {
...
EditionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(edition_entity_1.Edition)),
